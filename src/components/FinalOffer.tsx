      ...
      <div className="max-w-3xl mx-auto relative z-10 text-center">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 border-4 border-yellow-400 animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-xl border-2 border-blue-300 mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">🚀 Você Desbloqueou uma Oferta Secreta!</h2>
            <p className="text-lg text-gray-700 mb-4">
              Sua <strong>Página Profissional</strong> está reservada... mas só por tempo limitado.
            </p>
            <div className="flex items-center justify-center space-x-4 mb-4">
              <span className="text-3xl font-bold text-purple-600">Clique para revelar o presente 🎁</span>
            </div>
