...
const FinalOffer: React.FC<FinalOfferProps> = ({ totalEarned, onClaim }) => {
  ...
  // Ação do botão para aproveitar a oferta
  ...
  // Ação para revelar o presente misterioso
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-yellow-50 to-blue-100 p-4 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10 text-center">
        ...
        {/* Conteúdo principal - mistério ou oferta revelada */}
        {!revealed ? (
          <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 border-4 border-yellow-400 animate-fade-in">
            <h1 className="text-3xl font-bold text-gray-800 mb-6">
              🚀 Você Desbloqueou uma Oferta Secreta!
            </h1>
            <p className="text-lg text-gray-700 mb-6">
              Sua Página Profissional está reservada... mas só por tempo limitado.
            </p>
            <button
              onClick={handleRevealClick}
              className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-4 px-8 rounded-2xl shadow-lg transition transform hover:scale-105"
            >
              Clique para revelar o presente 🎁
            </button>
            <p className="mt-6 text-green-700 font-semibold">
              Seu bônus de R$ {totalEarned} acumulado no quiz foi ativado! Use com sabedoria. 🎯
            </p>
          </div>
        ) : (
          <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 border-4 border-green-500 animate-fade-in">
